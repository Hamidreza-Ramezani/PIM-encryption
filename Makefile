...
COMMON_FLAGS := -g -Wall -Wextra -Werror -fopenmp -pthread -I${COMMON_DIR} -I${CURDIR} -DNR_TASKLETS=${NR_TASKLETS} -DTRANSFER_SIZE=${TRANSFER_SIZE} -DPERFCOUNT_TYPE=${PERFCOUNT_TYPE}
...
HOST_FLAGS := ${COMMON_FLAGS} -I${HOST_DIR}  -lcrypto
