...
COMMON_FLAGS := -Wall -Wextra -Werror -fopenmp -pthread -I${COMMON_DIR} -I${CURDIR} -DNR_TASKLETS=${NR_TASKLETS} -DTRANSFER_SIZE=${TRANSFER_SIZE} -DPERFCOUNT_TYPE=${PERFCOUNT_TYPE}
